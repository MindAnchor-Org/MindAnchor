...
function Settings($$payload, $$props) {
  ...
  $$payload.out += `<div class="container svelte-129cq5b"><div class="page1-header svelte-129cq5b"><img src="/icon.png" alt="MindAnchor Logo" width="25px" class="svelte-129cq5b"> <h1 class="svelte-129cq5b">MindAnchor</h1></div> <hr> <nav class="nav-container svelte-129cq5b"><div class="nav-item svelte-129cq5b"><button class="icon svelte-129cq5b" type="button">📅 Schedules</button></div> <div class="nav-item svelte-129cq5b"><button class="icon svelte-129cq5b">📊 User Progress</button></div> <div class="nav-item svelte-129cq5b"><button class="icon svelte-129cq5b" type="button">$ Subscription</button></div> <div class="nav-item-active svelte-129cq5b"><button class="icon svelte-129cq5b" type="button">⚙️ Settings</button></div></nav> <br> <div class="settings-section svelte-129cq5b"><label class="svelte-129cq5b">Time allowed to access unlisted sites: <select class="svelte-129cq5b"><!--[-->`;
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    let option = each_array[$$index];
    $$payload.out += `<option${attr("value", option)} class="svelte-129cq5b">${escape_html(option)}</option>`;
  }
  $$payload.out += `<!--]--></select></label> <label class="svelte-129cq5b">Time allowed to access the dashboard when active: <select class="svelte-129cq5b"><!--[-->`;
  for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
    let option = each_array_1[$$index_1];
    $$payload.out += `<option${attr("value", option)} class="svelte-129cq5b">${escape_html(option)}</option>`;
  }
  $$payload.out += `<!--]--></select></label> <label class="svelte-129cq5b">Maximum inactivity duration before showing cues: <select class="svelte-129cq5b"><!--[-->`;
  for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
    let option = each_array_2[$$index_2];
    $$payload.out += `<option${attr("value", option)} class="svelte-129cq5b">${escape_html(option)}</option>`;
  }
  $$payload.out += `<!--]--></select></label> <label class="toggle-container svelte-129cq5b">Need for motivational cues during inactivity: <input type="checkbox"${attr("checked", needMotivationalCues, true)} class="toggle-input svelte-129cq5b"> <span class="toggle-slider svelte-129cq5b"></span></label></div> <h2 class="svelte-129cq5b">Set preferences for blacklisted site interference.</h2> <div class="settings-container svelte-129cq5b"><div class="image-upload-section svelte-129cq5b"><label class="svelte-129cq5b">Upload Image: <input type="file" accept="image/*"></label></div> <div class="preferences-section svelte-129cq5b"><label class="svelte-129cq5b">Image Alignment: <select class="svelte-129cq5b"><option class="svelte-129cq5b">Left</option><option class="svelte-129cq5b">Center</option><option class="svelte-129cq5b">Right</option></select></label> <label class="svelte-129cq5b">Animation Type: <select class="svelte-129cq5b"><option class="svelte-129cq5b">Fade</option><option class="svelte-129cq5b">Slide</option><option class="svelte-129cq5b">Zoom</option></select></label> <label class="svelte-129cq5b">Animation Duration: <select class="svelte-129cq5b"><option class="svelte-129cq5b">10 seconds</option><option class="svelte-129cq5b">20 seconds</option><option class="svelte-129cq5b">30 seconds</option></select></label> <label class="svelte-129cq5b">Background Colour: <input type="color"${attr("value", backgroundColor)} class="svelte-129cq5b"></label> <label class="svelte-129cq5b">Text Colour: <input type="color"${attr("value", textColor)} class="svelte-129cq5b"></label></div></div> <button class="save-btn svelte-129cq5b">Save Preferences</button></div>`;
  pop();
}
