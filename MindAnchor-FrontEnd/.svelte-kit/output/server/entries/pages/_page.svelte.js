...
function Settings($$payload, $$props) {
  ...
  $$payload.out += `<div class="container svelte-11gehyc"><div class="page1-header svelte-11gehyc"><img src="/icon.png" alt="MindAnchor Logo" width="25px" class="svelte-11gehyc"> <h1 class="svelte-11gehyc">MindAnchor</h1></div> <hr> <nav class="nav-container svelte-11gehyc"><div class="nav-item svelte-11gehyc"><button class="icon svelte-11gehyc" type="button">📅 Schedules</button></div> <div class="nav-item svelte-11gehyc"><button class="icon svelte-11gehyc">📊 User Progress</button></div> <div class="nav-item svelte-11gehyc"><button class="icon svelte-11gehyc" type="button">$ Subscription</button></div> <div class="nav-item-active svelte-11gehyc"><button class="icon svelte-11gehyc" type="button">⚙️ Settings</button></div></nav> <br> <div class="settings-section svelte-11gehyc"><label class="svelte-11gehyc">Time allowed to access unlisted sites: <select class="svelte-11gehyc"><!--[-->`;
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    let option = each_array[$$index];
    $$payload.out += `<option${attr("value", option)}>${escape_html(option)}</option>`;
  }
  $$payload.out += `<!--]--></select></label> <label class="svelte-11gehyc">Time allowed to access the dashboard when active: <select class="svelte-11gehyc"><!--[-->`;
  for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
    let option = each_array_1[$$index_1];
    $$payload.out += `<option${attr("value", option)}>${escape_html(option)}</option>`;
  }
  $$payload.out += `<!--]--></select></label> <label class="svelte-11gehyc">Maximum inactivity duration before showing cues: <select class="svelte-11gehyc"><!--[-->`;
  for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
    let option = each_array_2[$$index_2];
    $$payload.out += `<option${attr("value", option)}>${escape_html(option)}</option>`;
  }
  $$payload.out += `<!--]--></select></label> <label class="toggle-container svelte-11gehyc">Need for motivational cues during inactivity: <input type="checkbox"${attr("checked", needMotivationalCues, true)} class="toggle-input svelte-11gehyc"> <span class="toggle-slider svelte-11gehyc"></span></label></div> <h2 class="svelte-11gehyc">Set preferences for blacklisted site interference.</h2> <div class="settings-container svelte-11gehyc"><div class="image-upload-section svelte-11gehyc"><label class="svelte-11gehyc">Upload Image: <input type="file" accept="image/*" class="svelte-11gehyc"></label></div> <div class="preferences-section svelte-11gehyc"><label class="svelte-11gehyc">Image Alignment: <select class="svelte-11gehyc"><option>Left</option><option>Center</option><option>Right</option></select></label> <label class="svelte-11gehyc">Animation Type: <select class="svelte-11gehyc"><option>Fade</option><option>Slide</option><option>Zoom</option></select></label> <label class="svelte-11gehyc">Animation Duration: <select class="svelte-11gehyc"><option>10 seconds</option><option>20 seconds</option><option>30 seconds</option></select></label> <label class="svelte-11gehyc">Background Colour: <input type="color"${attr("value", backgroundColor)} class="svelte-11gehyc"></label> <label class="svelte-11gehyc">Text Colour: <input type="color"${attr("value", textColor)} class="svelte-11gehyc"></label></div></div> <button class="save-btn svelte-11gehyc">Save Preferences</button></div>`;
  pop();
}
